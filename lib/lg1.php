...
<div class="choice my-2 col-lg-6" id="l2">
	...
	<ul class="list-unstyled ch-item">
		...
		<li><br></li>
		<li><a href="{t:prefix}/lg1/pdf/2x.pdf"><img src="{t:prefix}/static/pdf_icon.png"> {t:lg1/pdf/2x}</a></li>
...
<div class="choice my-2 col-lg-6" id="l3">
	...
	<ul class="list-unstyled ch-item">
		...
		<li><br></li>
		<li><a href="{t:prefix}/lg1/pdf/3x.pdf"><img src="{t:prefix}/static/pdf_icon.png"> {t:lg1/pdf/3x}</a></li>
...
<div class="choice my-2 col-lg-6" id="l4">
	...
	<ul class="list-unstyled ch-item">
		...
		<li><br></li>
		<li><a href="{t:prefix}/lg1/pdf/4x.pdf"><img src="{t:prefix}/static/pdf_icon.png"> {t:lg1/pdf/4x}</a></li>
...
<div class="choice my-2 col-lg-6" id="l5.2">
	...
	<ul class="list-unstyled ch-item">
		...
		<li><br></li>
		<li><a href="{t:prefix}/lg1/pdf/5x.pdf"><img src="{t:prefix}/static/pdf_icon.png"> {t:lg1/pdf/5x}</a></li>
