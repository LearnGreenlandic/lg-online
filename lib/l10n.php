...
// src/TaskChooser.cpp
$l10n['dan'][''] = 'Strukturøvelse 1.2: Dan nye ord';
$l10n['eng'][''] = 'Pattern practice drill 1.2: Write new nouns';
// src/TaskChooser.cpp
$l10n['dan'][''] = 'Strukturøvelse 1.3: Lyt, forstå, dan ord';
$l10n['eng'][''] = 'Pattern practice drill 1.3: Listen and form new nouns';
// src/TaskChooser.cpp
$l10n['dan'][''] = 'Strukturøvelse 2.1: Dan nye ord';
$l10n['eng'][''] = 'Pattern practice drill 2.1: Write new verbs';
// src/TaskChooser.cpp
$l10n['dan'][''] = 'Strukturøvelse 2.2: Lyt, forstå, dan ord';
$l10n['eng'][''] = 'Pattern practice drill 2.2: Listen and form new verbs';
// src/TaskChooser.cpp
$l10n['dan'][''] = 'Strukturøvelse 3.1: Dan nye ord';
$l10n['eng'][''] = 'Pattern practice drill 3.1: Read and add endings';
// src/TaskChooser.cpp
$l10n['dan'][''] = 'Strukturøvelse 3.2: Lyt, forstå, dan ord';
$l10n['eng'][''] = 'Pattern practice drill 3.2: Listen and add endings';
// src/TaskChooser.cpp
...
// src/StructureOne.cpp
$l10n['dan'][''] = 'Brug N{-mi} for at vænne dig til lydændringerne. {1 ?} {2/?}';
$l10n['eng'][''] = 'Add the derivational morpheme N+MIU to the town names to form words meaning &apos;inhabitant of TOWN&apos;.
Do not get led astray by an orthographical detail that a word final q is written as an -r- whenever followed by another consonant. As you know already from the second lecture -r- in this position is not an -r- after all rather a gemination of the following consonant. Derivational morphemes are always added to the singular so we need to construct a singular form for the seven towns with pluralis tantum names. In this exercise the singulars you need are included for you. {1 ?} {2/?}';
// src/StructureOne.cpp
$l10n['dan'][''] = 'Brug N{-mi} for at vænne dig til lydændringerne. {1 ?} {3/?}';
$l10n['eng'][''] = 'Add the derivational morpheme N+MIU to the town names to form words meaning &apos;inhabitant of TOWN&apos;.
Do not get led astray by an orthographical detail that a word final q is written as an -r- whenever followed by another consonant. As you know already from the second lecture -r- in this position is not an -r- after all rather a gemination of the following consonant. Derivational morphemes are always added to the singular so we need to construct a singular form for the seven towns with pluralis tantum names. In this exercise the singulars you need are included for you. {1 ?} {3/?}';
// src/StructureOne.cpp
$l10n['dan'][''] = 'Lyt igen';
...
$l10n['dan'][''] = 'Denne øvelse er identisk med øvelse 1-2, men denne gang får du ingen hjælp af teksten. Du må klare dig med dine ører.
Sæt tilhænget N+MIU på bynavnene, så du danner ord med betydningen &apos;indbygger i BYNAVN&apos;. Udtal det nye ord højt og lyt derefter til Tikas indtaling af det samme ord. Klik &apos;næste&apos; når du er tilfreds med din egen udtale.
Hvis du slet ikke kan få ordet dannet inde i hovedet, må du som en sidste udvej vende tilbage til øvelse 1-2 for at forstå, hvad det er der foregår netop her.';
$l10n['eng'][''] = 'This exercise is identical to exercise 1-2 only that you this time do not get help from the written text. Your ears will suffice.
If you cannot at all make up the word in your head your last resource will be to return to exercise 1-2 to check up upon what is going on in just this word.';
// src/StructureThree.cpp
$l10n['dan'][''] = 'Denne øvelse er identisk med øvelse 2-2, men denne gang får du ingen hjælp af teksten. Du må klare dig med dine ører.
...
Hvis du slet ikke kan få ordet dannet inde i hovedet, må du som en sidste udvej vende tilbage til øvelse 2-2 for at forstå, hvad det er der foregår netop her.';
$l10n['eng'][''] = 'This exercise is identical to exercise 2-2 only that you this time do not get help from the written text. Your ears will suffice.
If you cannot at all make up the word in your head your last resource will be to return to exercise 2-2 to check up upon what is going on in just this word.';
// src/StructureThree.cpp
$l10n['dan'][''] = 'Øvelsen er identisk med øvelse 3.1, men denne gang får du ingen hjælp af teksten. Sæt endelsen N{-mi} på det bynavn, du hører for at danne ord med betydningen &apos;i BYNAVN&apos;.';
$l10n['eng'][''] = 'This exercise is identical with exercise 3.1 only that you this time do not get help from the written text. Your ears will suffice. Add the ending N{-mi} to the town name you hear to form words meaning &apos;in TOWN&apos;.';
// src/StructureThree.cpp
$l10n['dan'][''] = 'Lyt igen';
$l10n['eng'][''] = 'Listen again';
// src/StructureThree.cpp
...
$l10n['eng'][''] = 'Give up...';
// src/StructureThree.cpp
$l10n['dan'][''] = 'Hør den korrekte udtale';
$l10n['eng'][''] = 'Listen to the correct pronunciation';
// src/StructureThree.cpp
$l10n['dan'][''] = 'Gå til næste ord';
$l10n['eng'][''] = 'Go to next word';
// src/StructureThree.cpp
...
$l10n['eng'][''] = 'Correct!';
// src/StructureThree.cpp
$l10n['dan'][''] = 'Prøv nu selv at udtale ordet inden du hører den korrekte udtale.';
$l10n['eng'][''] = 'Try pronouncing the word before listening to the correct pronunciation.';
// src/StructureThree.cpp
$l10n['dan'][''] = 'Næsten korrekt.
Store og små bogstaver gælder...';
$l10n['eng'][''] = 'Almost correct.
...
$l10n['eng'][''] = 'The correct word was:';
// src/StructureThree.cpp
$l10n['dan'][''] = 'Skriv &quot;indbygger i bynavn&quot; formen:';
$l10n['eng'][''] = 'Write the &quot;citizen of city name&quot; form:';
// src/StructureThree.cpp
$l10n['dan'][''] = 'Skriv &quot;jeg er en indbygger i bynavn&quot; formen:';
$l10n['eng'][''] = 'Write the &quot;I am a citizen of city name&quot; form:';
// src/StructureThree.cpp
$l10n['dan'][''] = 'Skriv &quot;i bynavn&quot; formen:';
$l10n['eng'][''] = 'Write the &quot;in city name&quot; form:';
// src/StructureThree.cpp
$l10n['dan'][''] = 'Der er ikke mere i denne øvelse. Vil du fortsætte med næste øvelse?';
$l10n['eng'][''] = 'No tasks remain in this exercise. Do you want to continue with next exercise?';
// src/StructureThree.cpp
...
$l10n['dan'][''] = 'Sæt tilhænget N+MIU på bynavnene, så du danner ord med betydningen &apos;indbygger i BYNAVN&apos;.
Lad være med at lade dig snyde af den retskrivningsdetalje, at et q sidst i ordet STAVES som -r-, når der kommer en anden konsonant bagefter. Som du allerede ved det fra forelæsning 2, udtales -r- i denne stilling alligevel ikke som -r-, men som en fordobling af den konsonant, der kommer efter. Tilhæng sættes altid til entalsformen, så for de 7 byer, hvis navne er født med en flertalsendelse, skal du bruge den entalsform, du får serveret.';
$l10n['eng'][''] = 'Add the derivational morpheme N+MIU to the town names to form words meaning &apos;inhabitant of TOWN&apos;.
Do not get led astray by an orthographical detail that a word final q is written as an -r- whenever followed by another consonant. As you know already from the second lecture -r- in this position is not really an -r-, but rather a gemination of the following consonant. Derivational morphemes are always added to the singular so we need to construct a singular form for the seven towns with pluralis tantum names. In this exercise the singulars you need are included for you.';
// src/StructureTwo.cpp
$l10n['dan'][''] = 'Brug N+MIU-U{+vuŋa} så du danner ord med betydningen &apos;jeg er indbygger i BYNAVN&apos;. Brug øvelsen også til at vænne dig til forandringerne og samtidig til at klare udtalen af meget lange ord.
Tilhæng sættes altid til entalsformen, så for de 7 byer, hvis navne er født med en flertalsendelse, skal du først konstruere en entalsform. I denne øvelse er det gjort for dig (det er ordene i parentes).';
$l10n['eng'][''] = 'Use N+MIU-U{+vuŋa} to form words meaning &apos;I am an inhabitant of TOWN&apos;. The exercise will also help you to learn to cope with sound changes and the pronunciation of very long words.
Derivational morphemes are always added to the singular so for the seven pluralis tantum names one must first find the singular. In this exercise this has been taken care of for you (the forms in parentheses).';
// src/StructureTwo.cpp
$l10n['dan'][''] = 'Sæt endelsen N{-mi} på bynavnene for at danne ord med betydningen &apos;i BYNAVN&apos;.';
$l10n['eng'][''] = 'Add the ending N{-mi} to the town names to form words meaning &apos;in TOWN&apos;.';
// src/StructureTwo.cpp
$l10n['dan'][''] = 'Giv op...';
$l10n['eng'][''] = 'Give up...';
// src/StructureTwo.cpp
...
Try again...';
// src/StructureTwo.cpp
$l10n['dan'][''] = 'Skriv &quot;indbygger i %1&quot; formen:';
$l10n['eng'][''] = 'Write the &quot;citizen of %1&quot; form:';
// src/StructureTwo.cpp
$l10n['dan'][''] = 'Skriv &quot;jeg er en indbygger i %1&quot; formen:';
$l10n['eng'][''] = 'Write the &quot;I am a citizen of %1&quot; form:';
// src/StructureTwo.cpp
$l10n['dan'][''] = 'Skriv &quot;i %1&quot; formen:';
$l10n['eng'][''] = 'Write the &quot;in %1&quot; form:';
// src/StructureTwo.cpp
$l10n['dan'][''] = 'Bynavn:';
$l10n['eng'][''] = 'City name:';
// src/StructureTwo.cpp
