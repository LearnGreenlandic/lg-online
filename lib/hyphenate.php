...
<?php
	...
	foreach ($pngs as $png) {
		...
		echo '<div class="col-lg-6 my-2 text-center entry"><div class="row"><div class="col-12"><img src="{t:prefix}/'.$png.'" class="border border-secondary"/></div><div class="col-12"><input type="text" spellcheck="false" class="form-control" data-check="'.$hyphen.'" value="'.$word.'"> <button type="button" class="btn btn-warning">✓</button> <button type="button" class="btn btn-secondary">☼</button></div></div></div>';
	}
?>
</div>
</div>
